'use client';
import { REQUIRED_HEADER } from '@/app/Type/constant';
...
const BagDataLockerImport = () => {
    ...
    const handleFileUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        reader.onload = (event) => {
            ...
            const missingHeaders = REQUIRED_HEADER.filter(h => !fileHeader.includes(h));
            const extraHeaders = fileHeader.filter(h => !REQUIRED_HEADER.includes(h));
...
export default BagDataLockerImport
